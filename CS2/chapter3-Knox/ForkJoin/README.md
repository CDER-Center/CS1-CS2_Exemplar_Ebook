...
This course uses Peer Instruction, a pedagogy where lecture is interupted with multiple-choice quesitons.
The students answer these indidividually, then discuss them in groups and re-answer.
